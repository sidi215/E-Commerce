...
export default function DiagnosticDetailsPage() {
  const t = useTranslations('diagnosticDetails');
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <Card hover className="text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">{t('features.speed.title')}</h3>
            <p className="text-gray-600">{t('features.speed.description')}</p>
          </Card>

          <Card hover className="text-center">
            <div className="text-5xl mb-4">🎯</div>
            <h3 className="text-xl font-bold text-gray-900 mb-2">{t('features.accuracy.title')}</h3>
          ...
          <Card hover className="text-center">
            <div className="text-5xl mb-4">🌿</div>
            <h3 className="text-xl font-bold text-gray-900 mb-2">{t('features.variety.title')}</h3>
            <p className="text-gray-600">{t('features.variety.description')}</p>
          </Card>
        </div>
        ...
        <Card className="mb-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">{t('howItWorks.step4.title')}</h3>
        ...
        <Card className="mb-8 bg-green-50">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">{t('diseases.title')}</h2>
          <p className="text-gray-700 mb-4">{t('diseases.description')}</p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {['Tomates', 'Pommes de terre', 'Oignons', 'Dattes', 'Melons', 'Carottes'].map((crop, index) => (
